...
# Connect with S3 bucket with help of AWS secret key and access key using boto3 package

import boto3
import os
from US_Visa.constant import AWS_SECRET_ACCESS_KEY_ENV_KEY, AWS_ACCESS_KEY_ID_ENV_KEY, REGION_NAME
...
class S3Client:
    ...
    def __init__(self, region_name=REGION_NAME):
        ...
        if S3Client.s3_resource==None or S3Client.s3_client==None:
            ...
            # access class variable i.e class.varname (no need to create object)

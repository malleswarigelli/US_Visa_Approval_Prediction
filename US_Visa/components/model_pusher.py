...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        """
        # access s3 connection class, data access methods
        self.s3 = SimpleStorageService()
        self.model_evaluation_artifact = model_evaluation_artifact
        self.model_pusher_config = model_pusher_config
        # create object for USvisaEstimator class (has methods to save, retrieve model in s3 bucket and do prediction)
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            logging.info("Uploading best trained model from model_evaluation_artifact to s3 bucket")
